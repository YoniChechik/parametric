...
class local_file_picker(ui.dialog):
    def __init__(
        ...
        is_show_hidden_files: bool = False,
    ) -> None:
        """Local File Picker
        ...
        :param is_multiple: Whether to allow multiple files to be selected.
        :param is_show_hidden_files: Whether to show hidden files.
        """
        super().__init__()
        ...
        self.show_hidden_files = is_show_hidden_files
                ...
                ui.aggrid(
                    {
                        ...
                        "rowSelection": "multiple" if is_multiple else "single",
                    },
                    html_columns=[0],
                )
                .classes("w-96")
